...
public class LogView extends VerticalLayout implements AfterNavigationObserver {
    ...
    public LogView() {
        ...
        connectionCount = new Label();

        add(new H3("Recent Connection Changes"));
        add(connectionCount);
    ...
    private void doAfterNavigation() {
        ...
        connectionCount.setText("Count: " + configService.getRecentStartupCount());
    }
}
