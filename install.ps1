...
$action = New-ScheduledTaskAction -Execute 'powershell.exe' -Argument '-File C:\Users\skywall\skywall\ui\scripts\ping.ps1'
...
$restartAction = New-ScheduledTaskAction -Execute 'powershell.exe' -Argument '-File C:\Users\skywall\skywall\ui\scripts\restartService.ps1 -serviceName "SkyWall Filter"'
