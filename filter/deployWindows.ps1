...
cp C:\Users\moore\Code\skywall\dist\Python39\Lib\site-packages\mitmproxy\platform\windows.py $installDir\dist\Python39\Lib\site-packages\mitmproxy\platform
if (Get-Service "SkyWall Filter" -ErrorAction SilentlyContinue) {
